...
namespace Project132 {
    ...
    private: System::Windows::Forms::TextBox^ textBoxRoom; // Moved textBoxRoom to the top
...
#pragma region Windows Form Designer generated code
        void InitializeComponent(void)
        {
            ...
            // textBoxRoom
            // 
            this->textBoxRoom->Location = System::Drawing::Point(367, 17);
            ...
            // textBoxTeacherName
            // 
            this->textBoxTeacherName->Location = System::Drawing::Point(367, 45);
            ...
            // textBoxCourse
            // 
            this->textBoxCourse->Location = System::Drawing::Point(367, 73);
            ...
            this->deleteButton->Click += gcnew System::EventHandler(this, &Classroomwise::deleteButton_Click);
            // 
            // label1
            // 
            ...
            this->label2->Text = L"Teacher Name";
            // 
            // label3
            // 
    ...
    private:
        ...
        System::Void addButton_Click(System::Object^ sender, System::EventArgs^ e) {
            String^ room = textBoxRoom->Text; // Changed the sequence to match the textbox sequence
            ...
            if (!String::IsNullOrEmpty(room) && !String::IsNullOrEmpty(teacherName) && !String::IsNullOrEmpty(course) &&
                !String::IsNullOrEmpty(day) && !String::IsNullOrEmpty(startTime) && !String::IsNullOrEmpty(endTime) &&
                !String::IsNullOrEmpty(section)) {
                AddTimetableForTeacher(room, teacherName, course, day, startTime, endTime, section);
            }
            else {
        ...
        void AddTimetableForTeacher(String^ room, String^ teacherName, String^ course, String^ day, String^ startTime, String^ endTime, String^ section) {
            String^ connectionString = "Data Source=DESKTOP-AKQDUJ4\\SQLEXPRESS;Initial Catalog=Timetable;Integrated Security=True";
            String^ query = "INSERT INTO [dbo].[USER4] (Room, TeacherName, Course, Day, StartTime, EndTime, Section) VALUES (@Room, @TeacherName, @Course, @Day, @StartTime, @EndTime, @Section)";
        ...
        System::Void deleteButton_Click(System::Object^ sender, System::EventArgs^ e) {
            ...
            if (!String::IsNullOrEmpty(room)) {
                DeleteTimetableForRoom(room);
            }
            else {
                MessageBox::Show("Please enter a Room number.", "Information", MessageBoxButtons::OK, MessageBoxIcon::Information);
            }
        }

        void DeleteTimetableForRoom(String^ room) {
            String^ connectionString = "Data Source=DESKTOP-AKQDUJ4\\SQLEXPRESS;Initial Catalog=Timetable;Integrated Security=True";
            String^ query = "DELETE FROM [dbo].[USER4] WHERE [Room] = @Room";
            ...
            try {
                ...
                if (result > 0) {
                    ...
                    MessageBox::Show("No records found for the specified Room.", "Information", MessageBoxButtons::OK, MessageBoxIcon::Information);
                }
